...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/FrancescoStabile/numasec/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for FrancescoStabile/numasec...\n")
